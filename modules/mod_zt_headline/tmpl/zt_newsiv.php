...
$document->addStyleSheet(JURI::base() . 'modules/mod_zt_headline/assets/css/zt_newsiv.css');
$document->addScript(JURI::base() . 'modules/mod_zt_headline/assets/js/newsiv.js');
$cssMod 	= "height: ".$moduleHeight."px;";
$effect = $params->get('zt_newsiv_effect');
$itemwidth = $params->get('NewsIVitemWidth', 250);
$pagenav = $params->get('zt_newsiv_enable_btn');
$noslide = $params->get('zt_newsiv_no_item'); 
$enabledesc = $params->get('zt_newsiv_enable_description');
$enabletitle = $params->get('zt_newsiv_enable_title');
$auto = $params->get('zt_newsiv_autorun');
...
$scroll = $params->get('zt_newsiv_running',1);
...
?>
<div class="zt_newsiv">
<div id="zt_newsiv<?php echo $moduleId;?>" class="newsiv-slider" style="<?php echo $cssMod;?>">  
...
Zoo(document).ready(function() { 
	Zoo(function() {
		Zoo("#zt_newsiv<?php echo $moduleId;?>").jCarouselLite({
			<?php if($pagenav){?>
